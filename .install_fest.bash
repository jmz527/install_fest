...
# Thanks to Phillip Lamplugh and PJ Hughes for their installfest script which
#  you can find here: https://github.com/GA-WDI/installfest
...
toolpkglist=(
  ...
  # Node is a JavaScript runtime enviornment built on V8 for building network applications
  node
